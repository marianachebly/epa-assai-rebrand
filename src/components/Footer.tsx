...
const Footer = () => {
  const whatsappUrl = "https://api.whatsapp.com/send?phone=5531997838433&text=Ol%C3%A1%2C+gostaria+de+receber+informa%C3%A7%C3%B5es+da+campanha+de+66+anos+do+anivers%C3%A1rio+do+Epa%21&utm_source=LP+campanha&utm_medium=WhatsApp&utm_campaign=Anivers%C3%A1rio+EPA+66+anos&utm_id=66+anos&utm_term=Anivers%C3%A1rio+EPA";
      ...
      <footer className="bg-gradient-to-br from-primary via-primary to-secondary text-primary-foreground py-12 relative">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4">
            <img src={logoRodape} alt="EPA 66 Anos" className="h-20 w-auto mx-auto" width={74} height={80} loading="lazy" />
        ...
        >
          ...
          <img src={logoBy} alt="Listra Digital" className="h-4 w-auto" width={60} height={16} loading="lazy" />
        </a>
      </footer>
    </>
  );
